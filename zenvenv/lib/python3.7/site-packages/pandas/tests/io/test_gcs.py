...
def test_read_csv_gcs(monkeypatch):
    ...
    df2 = read_csv("gs://test/default.csv", parse_dates=["dt"])
...
def test_to_csv_gcs(monkeypatch):
    ...
    monkeypatch.setattr("gcsfs.GCSFileSystem", MockGCSFileSystem)
    df1.to_csv("gs://test/default.csv", index=True)
    ...
    df2 = read_csv("gs://test/default.csv", parse_dates=["dt"], index_col=0)
...
def test_to_parquet_gcs_new_file(monkeypatch, tmpdir):
    ...
    monkeypatch.setattr("gcsfs.GCSFileSystem", MockGCSFileSystem)
    df1.to_parquet(
        "gs://test/default.csv", index=True, engine="fastparquet", compression=None
    )
