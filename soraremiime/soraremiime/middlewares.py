...
class soraremiimeSelenium_Middleware(object):
    ...
    def process_request(self, request, spider):
        ...
        driver.get('https://miime.io/assets/12')
...
class SoraremiimeSpiderMiddleware(object):
...
class SoraremiimeDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
