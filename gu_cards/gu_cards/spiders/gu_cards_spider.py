...
class guCardsMeteorite_1_Spider(scrapy.Spider):
    ...
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_1_Middleware': 520},
...
class guCardsMeteorite_2_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_2_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_3_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_3_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_4_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_4_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_5_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_5_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_6_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_6_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_7_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_7_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_8_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_8_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_9_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_9_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_10_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_10_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_11_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_11_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_12_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_12_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_13_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_13_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_14_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_14_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_15_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_15_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_16_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_16_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
...
class guCardsMeteorite_17_Spider(scrapy.Spider):
    ...
    start_urls = ['https://gu.cards/?marketplace=with_listings']
    custom_settings = {
        "DOWNLOADER_MIDDLEWARES": {'gu_cards.middlewares.guCardsMeteorite_17_Middleware': 520},
        "FEED_EXPORT_ENCODING": 'utf-8',
        "FEED_FORMAT": 'json',
        "FEED_URI": 'guCardsMeteorite.json',
    }
